            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: List.generate(data['p_colors'].length, (index) => Stack(
                                ...
                                children:[ VxBox().size(40, 40)
                                    .roundedFull.margin(const EdgeInsets.symmetric(horizontal: 6))
                                    .color(Color(data['p_colors'][index]).withOpacity(1.0)).make().onTap(() {
                  ...
                  10.heightBox,
                  desc.text.color(darkFontGrey).semiBold.make(),
                  10.heightBox,
                ...
                ListView(
                  ...
                  20.heightBox,
                  prodsyoylike.text.fontFamily(bold).size(16).color(darkFontGrey).make(),
                  10.heightBox,
              ...
              child: LoginButton(
                ...
                onPress: (){
                  if(controller.quantity.value>0){
                    ...
                    VxToast.show(context, msg: 'Select atleast one product');
                  }
