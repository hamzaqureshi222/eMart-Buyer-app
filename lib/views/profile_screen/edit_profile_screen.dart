        ...
        body: Stack(children: [
          Column(
            ...
            children: [
              ...
              data['imageUrl']=='' && controller.profileImgPAth.isEmpty?Image.asset(imgProfile,width: context.screenHeight*0.2,fit: BoxFit.cover,).box.roundedFull.clip(Clip.antiAlias).make()
              // if data is not
                  :data['imageUrl']!=null && controller.profileImgUrl.isEmpty?
              Image.network(data['imageUrl'],width: context.screenHeight*0.1,fit: BoxFit.fill,).box.roundedFull.clip(Clip.antiAlias).make()
              ...
              LoginButton(color: redColor,onPress: ()async{
              ...
              },textColor: whiteColor,title: "Upload "),
              const Divider(),
              20.heightBox,
              CustomField(
              ...
              SizedBox(
                  ...
                  child: LoginButton(color: redColor,onPress: ()async{
                  ...
                  },textColor: whiteColor,title: "Update ")),
            ],
          ...
          Positioned(
              ...
              },color:Colors.black,height: 10,shape: const CircleBorder(),
